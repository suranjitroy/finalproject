        ...
        <div class="content">
            ...
            <div class="row animated fadeInUp">
                ...
                <div class="col-sm-12 col-md-6">
                    <h4 class="section-subtitle"><b>Blog</b> Edit</h4>
                    <div class="panel">
                                ...
                                <div class="col-md-12">
                                    <form  action="{{ route('admin.blog.update', $data->id) }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="blog_title" value="{{ $data->blog_title }}"placeholder="Blog Title">
                                        </div>
                                        <div class="form-group">
                                            <label for="address">Blog Description</label>
                                            <textarea class="form-control" id="address" name="blog_description" rows="5">{{ $data->blog_description }}</textarea>
