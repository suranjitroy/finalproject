        ...
        <div class="content">
            ...
            <div class="row animated fadeInUp">
                ...
                <div class="col-sm-12 col-md-5">
                    <h4 class="section-subtitle"><b>Profile</b> Entry</h4>
                                ...
                                <div class="col-md-12">   
                                    <div>
                                        <div class="profile-photo">
                                            <img alt="User photo" src="{{ asset('images/avatar/avatar_user.jpg') }}" />
                                        </div>
                                        <div class="user-header-info">
                                            <h2 class="user-name">{{ $data->first_name }} {{ $data->last_name }}</h2>
                                            {{-- @if($data->email == 'sathi@gmail.com')
                                            <h5 class="user-position">Laravel Developer</h5>
                                            @else
                                            <h5 class="user-position">please set up your profile</h5>
                                            @endif --}}
