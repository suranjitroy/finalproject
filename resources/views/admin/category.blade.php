        ...
        <div class="content">
            ...
            <div class="row animated fadeInUp">
                ...
                <div class="col-sm-12 col-md-5">
                    <h4 class="section-subtitle"><b>Company Category</b> Entry</h4>
                    <div class="panel">
                        <div class="panel-content">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form  action="{{ route('categoryinfo') }}" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <label for="name">Company Category Name</label>
                ...
                <div class="col-sm-12 col-md-7">
                        <h4 class="section-subtitle"><b>Company Category List</b></h4>
                        <div class="panel">
                            <div class="panel-content">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-xs">
                                                    <a href="{{ route('categoryedit', $data->id) }}"class="btn btn-transparent"><i class="fa fa-pencil"></i>
                                                    </a>
